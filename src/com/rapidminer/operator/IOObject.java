...
public interface IOObject extends Serializable {
    ...
    /**
     * This method is called if this IOObject is put out of the specified port after
     * being created or processed by the given operator. This method has to keep track of 
     * the processing stations of this object, so that they are remembered and might be returned by the method 
     * getProcessingHistory. 
     */
    public void appendOperatorToHistory(Operator operator, OutputPort port);

    /**
     * This method must return a list of each step of processing steps this IOObject has
     * been made including it's creating operator.
     */
