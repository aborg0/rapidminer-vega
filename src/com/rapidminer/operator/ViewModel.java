 ...
 * {@link ModelViewExampleSet} one can create a new view of the data by applying
 * the necessary transformations defined by this view model. 
 *
...
public interface ViewModel extends Model {
	 ...
	 * @param targetAttribute the attribute, which asks for his value
	 * @param value  the value the source attribute had in original data
