 ...
 * 
 * @author Ingo Mierswa
 *          07:47:16 ingomierswa Exp $
 */
public class AggregationNonDominatedSortingSelection implements AggregationSelection {

	/**
	 * The comparator for aggregation individuals using the fitness values of
	 * the m-th criterion.
	 */
	...
	/**
	 * Sorts the given rank by crowding distance (i.e. the
	 * &quot;neighborhoodship&quot; in the fitness space).
	 */
