...
/**
 * This operator creates a flat cluster model using a nominal attribute and dividing the exampleset by this attribute
 * over the clusters. Every value is mapped onto a cluster, including the unkown value.
...
public class ExampleSet2ClusterModel extends Operator {
	...
	public ExampleSet2ClusterModel(OperatorDescription description) {
		...
		exampleSetInput.addPrecondition(new AttributeSetPrecondition(exampleSetInput, AttributeSetPrecondition.getAttributesByParameter(this, PARAMETER_ATTRIBUTE)));
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeAttribute(PARAMETER_ATTRIBUTE, "Specifies the nominal attribute used to create the cluster", exampleSetInput, false));
