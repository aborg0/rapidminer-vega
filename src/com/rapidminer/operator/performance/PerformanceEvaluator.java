...
/**
 * <p>A performance evaluator is an operator that expects a test {@link ExampleSet}
 ...
 * 
 * <p>Additional user-defined implementations of {@link PerformanceCriterion} 
 ...
 * that these classes extend {@link MeasuredPerformance} since the PerformanceEvaluator
...
public class PerformanceEvaluator extends AbstractPerformanceEvaluator {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeList(PARAMETER_CLASS_WEIGHTS, "The weights for all classes, empty: using 1 for all classes.", 
