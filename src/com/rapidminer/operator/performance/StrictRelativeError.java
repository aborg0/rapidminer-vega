...
/**
 * The average relative error in a strict way of calculation: 
 * <i>Sum(|label-predicted|/min(|label|, |predicted|))/#examples</i>.
 * The relative error of label 0 and prediction 0 is defined as 0.
 * If the minimum of label and prediction is 0, the relative error is
 * defined as infinite.
 * 
 * @author Ingo Mierswa
 */
