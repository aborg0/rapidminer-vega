...
public final class ProcessRootOperator extends OperatorChain {
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterType parameterRecepient = new ParameterTypeString(PARAMETER_NOTIFICATION_EMAIL, "Email address for the notification mail.", System.getProperty(RapidMiner.PROPERTY_RAPIDMINER_TOOLS_MAIL_DEFAULT_RECIPIENT));
		...
		int defaultTime;		
		try {
			defaultTime = Integer.parseInt(System.getProperty(RapidMiner.PROPERTY_RAPIDMINER_TOOLS_MAIL_DEFAULT_PROCESS_DURATION_FOR_MAIL));
		} catch (NumberFormatException e) {
			defaultTime = 30;
		}		
