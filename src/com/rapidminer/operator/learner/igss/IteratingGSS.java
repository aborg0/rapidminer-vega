...
/**
 * This operator implements the IteratingGSS algorithms presented in the diploma thesis
 * 'Effiziente Entdeckung unabh&auml;ngiger Subgruppen in grossen Datenbanken' at the 
...
public class IteratingGSS extends AbstractLearner {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(type);
		type = new ParameterTypeBoolean(PARAMETER_FORCE_ITERATIONS, "make all iterations even if termination criterion is met", false);
		type.setExpert(false);
		types.add(type);
