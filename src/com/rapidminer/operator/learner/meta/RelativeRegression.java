...
public class RelativeRegression extends AbstractMetaLearner {
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterType type = new ParameterTypeAttribute(PARAMETER_RELATIVE_ATTRIBUTE, "Select the attribute which should be used as a base for the relative comparison.", exampleSetInput, Ontology.NUMERICAL) {
