...
public class AdaBoostPerformanceMeasures extends WeightedPerformanceMeasures {
	...
	/**
	 * This method reweights the example set with respect to the performance
	 * measures. Please note that the weights will not be reset at any time,
	 * because they continuously change from one iteration to the next.
	 * 
	 * @param exampleSet
