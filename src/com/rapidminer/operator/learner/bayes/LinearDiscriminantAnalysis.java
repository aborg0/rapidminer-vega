...
/**
 * <p>This operator performs a linear discriminant analysis (LDA). This method tries to find the 
 ...
 * (i.e. the class label).</p>
 *
 * <p>LDA is also closely related to principal component analysis (PCA) and factor analysis in 
 ...
 * take into account any difference in class.</p>
 * 
