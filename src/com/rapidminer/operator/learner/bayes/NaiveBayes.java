...
public class NaiveBayes extends AbstractLearner {
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterType type = new ParameterTypeBoolean(PARAMETER_LAPLACE_CORRECTION, "Use Laplace correction to prevent high influence of zero probabilities.", true, false);
		type.setExpert(true);
		types.add(type);
		return types;
	}
