...
public class SimpleRuleLearner extends AbstractLearner {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeDouble(PARAMETER_PURENESS, "The desired pureness, i.e. the necessary amount of the major class in a covered subset in order become pure.", 0.0d, 1.0d, 0.9d, false));
		return types;
	}
}
