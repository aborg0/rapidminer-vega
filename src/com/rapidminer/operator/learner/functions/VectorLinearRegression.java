...
/**
 *  This operator performs a vector linear regression. It regresses all regular
 *  attributes upon a vector of labels. The attributes forming the vector have
 *  to be marked as special, the special role names of all label attributes have
 *  to start with <code>label</code>.
 *
