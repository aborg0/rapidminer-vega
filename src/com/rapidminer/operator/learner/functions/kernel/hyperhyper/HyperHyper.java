 ...
 * and one negative example. Typically this operator is used in combination with a
 * boosting method.
 * 
...
public class HyperHyper extends AbstractLearner {
	...
	public ResourceConsumptionEstimator getResourceConsumptionEstimator() {
		return OperatorResourceConsumptionHandler.getResourceConsumptionEstimator(getExampleSetInputPort(), HyperHyper.class, null);
	}
}
