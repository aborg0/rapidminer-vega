			...
			if (weights != null) {
				for (Example example : exampleSet) {
					...
					if (getLabel().isNominal()) {
						...
						example.setConfidence(predLabel.getMapping().getPositiveString(), 1.0d / (1.0d + java.lang.Math.exp(-sum)));
						example.setConfidence(predLabel.getMapping().getNegativeString(), 1.0d / (1.0d + java.lang.Math.exp(sum)));
					} else {
