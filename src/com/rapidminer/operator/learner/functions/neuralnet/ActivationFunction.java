...
/**
 * This is the activation function of a neural net node. This class performs the calculation
 * of the node's output values as well as the error calculation and the update of the weights.
 *
 * @author Ingo Mierswa
 */
