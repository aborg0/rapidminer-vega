...
/**
 * This node represents the output node(s) of a neural network. It uses a sigmoid
 * activation function for classification tasks (one node for each class) and
 * a linear function for regression tasks.
 * 
 * @author Ingo Mierswa
 */
