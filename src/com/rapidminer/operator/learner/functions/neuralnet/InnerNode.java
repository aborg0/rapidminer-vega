...
/**
 * This class is used to represent a hidden node in the neural net. The base
 * difference to the input and output nodes is that the inner nodes performs the 
 * weight handling while the input nodes only use the input values and the 
 * output nodes simply produce the output value(s).
 * 
 * @author Ingo Mierswa
 */
