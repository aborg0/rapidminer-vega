...
/**
 * This neighborhood includes a fraction of the complete training data set. So the number
 * of nearest neighbors depends on the size of the training set but at least 1.
 * 
...
public class RelativeNeighborhood implements Neighborhood {
	...
	public List<ParameterType> getParameterTypes(ParameterHandler handler) {
		...
		ParameterType type = new ParameterTypeDouble(PARAMETER_RELATIVE_SIZE, "Specifies the size of the neighborhood relative to the total number of examples. A value of 0.04 would include 4% of the data points into the neighborhood.", 0, 1);
	...
	public String toString() {
		return "Relative neighborhood with a fraction of " + Tools.formatNumber(relativeSize, 3) + " of the complete data set";
	}
}
