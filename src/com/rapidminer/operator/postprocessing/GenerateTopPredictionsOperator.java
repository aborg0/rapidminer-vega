 ...
 */
public class GenerateTopPredictionsOperator extends AbstractExampleSetProcessing {
	public static final String PARAMETER_NUMBER_OF_PREDICTIONS = "number_of_predictions";
	public static final String PARAMETER_REMOVE_OLD_CONFIDENCES = "remove_old_confidences";


	public GenerateTopPredictionsOperator(OperatorDescription description) {
		super(description);
	...
	public ExampleSet apply(ExampleSet exampleSet) throws OperatorException {
		...
		int k = Math.min(numberOfLabels, getParameterAsInt(PARAMETER_NUMBER_OF_PREDICTIONS));
		...
		if (getParameterAsBoolean(PARAMETER_REMOVE_OLD_CONFIDENCES)) {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeInt(PARAMETER_NUMBER_OF_PREDICTIONS, "This determines how many top predictions will be generated. ", 2, Integer.MAX_VALUE, false));
		types.add(new ParameterTypeBoolean(PARAMETER_REMOVE_OLD_CONFIDENCES, "This indicates if the old confidence attributes should be removed.", true, false));
