...
/**
 * This model removes all nominal values. During application it might happen
 * that missing values are introduced.
 * If applied on data, new columns are created in a cloned example set.
 * 
    ...
    public ExampleSet applyOnData(ExampleSet exampleSet) throws OperatorException {
        ...
        while (iterator.hasNext()) {
            ...
            if (mappingTranslation != null) {
                ...
                Attribute newAttribute = AttributeFactory.createAttribute(currentAttribute.getName(), currentAttribute.getValueType(), currentAttribute.getBlockType());
