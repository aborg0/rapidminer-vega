...
public interface AttributeFilterCondition {
	 ...
	 * @throws UserError 
	 * @throws ConditionCreationException TODO*/
	 ...
	 * @param attribute the meta data of the attribute
	 * @param parameterHandler to get the value of the defined parameters
	 * @return
	...
	/**
	 * Indicates that this filter needs a full data scan and can evaluate its condition only after the full
	 * scan has been performed. If this method returns true, isNeedingScan must have returned true either. 
	 */
	...
	/**
	 * This method has to be invoked after a full scan has been performed if the isNeedingFullScan method
	 * returns true. 
