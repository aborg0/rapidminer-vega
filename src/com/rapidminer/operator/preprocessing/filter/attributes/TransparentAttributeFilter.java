...
/**
 * This filter actually does nothing and removes no attribute. It is needed to create a 
 * behavior consistent with earlier versions and to allow to bundle the filtering with an 
