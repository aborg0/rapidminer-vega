...
public class RegexpAttributeFilter extends AbstractAttributeFilterCondition {
	...
	public List<ParameterType> getParameterTypes(ParameterHandler operator, final InputPort inPort, final int...valueTypes) {
		...
		ParameterType type = (new ParameterTypeRegexp(PARAMETER_EXCEPT_REGULAR_EXPRESSION, "A regular expression for the names of the attributes which should be filtered out although matching the above regular expression.", true, true) {
