...
public class FeatureValueTypeFilter extends FeatureFilter {
	...
	public boolean switchOffFeature(AttributeRole role) throws OperatorException {
		...
		if (exceptionType == 0) {
			...
			return 
			Ontology.ATTRIBUTE_VALUE_TYPE.isA(feature.getValueType(), type) &&
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterType type = new ParameterTypeCategory(PARAMETER_SKIP_FEATURES_OF_TYPE, "All features of this type will be deselected.", valueTypes, 0);
