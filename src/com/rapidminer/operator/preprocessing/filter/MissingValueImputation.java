 ...
 * the corresponding attributes might be chosen by the filter parameters. 
 * 
 ...
 * some cases. This behavior leads to a warning. It might hence be useful to combine
...
public class MissingValueImputation extends OperatorChain {
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterType type = new ParameterTypeBoolean(PARAMETER_ITERATE, "Impute missing values immediately after having learned the corresponding concept and iterate.", true);
	...
	public ResourceConsumptionEstimator getResourceConsumptionEstimator() {
		return OperatorResourceConsumptionHandler.getResourceConsumptionEstimator(getInputPorts().getPortByIndex(0), MissingValueImputation.class, attributeSelector);
	}
}
