 ...
 * by an AttributeSubsetPreprocessing operator with the parameter process_special_attributes enabled.
 * 
 * @author Ingo Mierswa
 */
public class MergeNominalValues extends AbstractDataProcessing {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeAttribute(PARAMETER_ATTRIBUTE_NAME, "The name of the nominal attribute which values should be merged.", getExampleSetInputPort(), false));
