...
public class FeatureBlockTypeFilter extends FeatureFilter {
	...
	public boolean switchOffFeature(AttributeRole role) throws OperatorException {
        ...
        if (exceptionType == 0) {
            ...
            return 
                Ontology.ATTRIBUTE_BLOCK_TYPE.isA(feature.getBlockType(), type) &&
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterType type = new ParameterTypeCategory(PARAMETER_SKIP_FEATURES_OF_TYPE, "All features of this type will be deselected off.", blockTypes, 0);
