...
/**
 * This operator creates new attributes from nominal attributes where the new attributes contain only
...
public class AttributeValueSubstring extends AbstractValueProcessing {
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterType type = new ParameterTypeInt(PARAMETER_FIRST, "The index of the first character of the substring which should be kept (counting starts with 1, 0: start with beginning of value).", 1, Integer.MAX_VALUE, 1);
