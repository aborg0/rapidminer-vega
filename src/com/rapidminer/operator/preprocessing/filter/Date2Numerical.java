...
public class Date2Numerical extends AbstractDateDataProcessing {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeAttribute(PARAMETER_ATTRIBUTE_NAME, "The attribute which should be parsed.", getExampleSetInputPort(), false, false, Ontology.DATE_TIME));
