...
public class ExampleRangeFilter extends AbstractDataProcessing {
	...
	public ExampleRangeFilter(OperatorDescription description) {
		...
		getExampleSetInputPort().addPrecondition(new ExampleSetSizePrecondition(getExampleSetInputPort(), this, PARAMETER_FIRST_EXAMPLE, PARAMETER_LAST_EXAMPLE));
	}
