...
/**
 * <p>This operator creates new attributes from nominal attributes where
 * the new attributes contain the original values which replaced substrings.
 * The replace_what parameter can be defined as a regular expression (please
 * refer to the annex of the RapidMiner tutorial for a description). The
 * replace_by parameter can be defined as an arbitrary string. Empty strings
 * are also allowed. Capturing groups of the defined regular expression can
 * be accessed with $1, $2, $3...</p>
 *  
