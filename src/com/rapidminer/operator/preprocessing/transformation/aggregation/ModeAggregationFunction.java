...
/**
 * This class implements the Mode Aggregation function. This will calculate the mode value of
 * the attribute of the examples within a group.
 * @author Sebastian Land
 */
public class ModeAggregationFunction extends NominalAggregationFunction {
    ...
    public ModeAggregationFunction(Attribute sourceAttribute, boolean ignoreMissings) {
        super(sourceAttribute, ignoreMissings, FUNCTION_MODE, FUNCTION_SEPARATOR_OPEN, FUNCTION_SEPARATOR_CLOSE);
    }
