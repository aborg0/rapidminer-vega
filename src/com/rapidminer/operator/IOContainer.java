 ...
 * 
 * From Version 5.0 on, IOContainers are only used for compatibility reasons
 * and are only a collection of IOObjects. IOContainers are no longer
 * passed between Operators and hence most of its functionality is obsolete.
 * 
...
public class IOContainer implements Serializable {
	 ...
	 * the object is afterwards removed from this IOContainer.
	 */
