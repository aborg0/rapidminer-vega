...
/**
 * This is the result of the TransitionGraphOperator, i.e. a graph representing
 * connections between items (can be used for network visualizations).
 * 
 * @author Ingo Mierswa
 */
public class TransitionGraph extends ResultObjectAdapter {
	...
	public TransitionGraph(ExampleSet exampleSet, String sourceAttribute, String targetAttribute, String strengthAttribute, String typeAttribute, String nodeDescription) {
