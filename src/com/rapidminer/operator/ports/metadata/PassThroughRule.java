...
/** Assigns meta data received from an input port to an output port. Useful e.g. for preprocessing operators. 
 *  If meta data changes dynamically, can be modified by overriding {@link #modifyMetaData(MetaData)}. 
 *  
