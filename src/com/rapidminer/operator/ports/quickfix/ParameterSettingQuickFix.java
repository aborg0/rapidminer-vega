...
public class ParameterSettingQuickFix extends AbstractQuickFix {
    ...
    /**
     * This constructor will build a quickfix that let's the user select an appropriate
    ...
    /**
     * This constructor will build a quickfix that will automatically set the parameter to the given value without
     * further user interaction. Use this constructor if you can comprehend the correct value.
     */
