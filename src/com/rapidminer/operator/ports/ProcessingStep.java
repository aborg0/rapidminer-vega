 ...
 * Currently the name of the operator and port is remembered.
 * 
...
public class ProcessingStep {
	...
	/**
	 * This constructor builds a ProcessingStep from the current operator
	 * and the used outputport of the respective IOObject.
	 */
