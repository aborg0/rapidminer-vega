...
/**
 * This is the interface for all OperatorLibraries. These are objects that contain
 * the description of an arbitrary number of Operators, together with their documentation.
 * 
...
public interface OperatorLibrary extends Serializable {
    ...
    /**
     * This method returns the {@link OperatorDescription} associated
     * with the given key.
     */
    ...
    /**
     * This returns a {@link OperatorDocBundle} that contains information about each
     * single delivered {@link Operator} of this library.
     */
    ...
    /**
     * This returns a short textual description of the functionality provided by
     * this {@link OperatorLibrary}.
     */
    public String getSynopsis();

    /**
     * This returns a HTML fragment that in detail describes the inner working of
     * this {@link OperatorLibrary}.
     */
    public String getDocumentation();

    /**
     * This method returns a {@link VersionNumber} that is the version of this {@link OperatorLibrary}.
     */
    public VersionNumber getVersion();

    /**
     * This method returns the namespace of this OperatorLibrary. These namespaces are
     * used to distinguish between different libraries. The namespace should be
     * unique and must be of the form: rmol_"Qualifier".
     */
     ...
     * used to distinguish between different libraries. The namespace should be
     * unique and must be of the form: rmol_"Qualifier". In order to make it unique a random suffix is
     * added. This returns the original namespace name given by user.
     */
    ...
    /**
     * This sets a short textual description of the functionality provided by
     * this {@link OperatorLibrary}.
     */
    public void setSynopsis(String newSyopsis);

    /**
     * This sets a HTML fragment that in detail describes the inner working of
     * this {@link OperatorLibrary}.
     */
