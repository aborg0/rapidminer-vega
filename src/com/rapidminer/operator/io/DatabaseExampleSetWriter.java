...
public class DatabaseExampleSetWriter extends AbstractExampleSetWriter implements ConnectionProvider {
	...
	public ExampleSet write(ExampleSet exampleSet) throws OperatorException {		
		try {
			...
			databaseHandler.createTable(exampleSet, getParameterAsString(DatabaseHandler.PARAMETER_TABLE_NAME), getParameterAsInt(PARAMETER_OVERWRITE_MODE), getApplyCount() == 1, getParameterAsBoolean(PARAMETER_SET_DEFAULT_VARCHAR_LENGTH) ? getParameterAsInt(PARAMETER_DEFAULT_VARCHAR_LENGTH) : -1);
