...
public class IOObjectReader extends AbstractReader<IOObject> {
	...
	public IOObject read() throws OperatorException {
		...
		if (object == null) {
			...
			if (!(clazz.isInstance(object)) && !getParameterAsBoolean(PARAMETER_IGNORE_TYPE)) {
				throw new UserError(this, 942, new Object[] { getParameter(PARAMETER_OBJECT_FILE), clazz.getSimpleName(), object.getClass().getSimpleName() });
			} else {
				return object;
			}
		}
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterType type = new ParameterTypeCategory(PARAMETER_IO_OBJECT, "The class of the object(s) which should be saved.", getIOObjectNames(), 0, false);
