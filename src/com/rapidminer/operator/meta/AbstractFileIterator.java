...
public abstract class AbstractFileIterator extends OperatorChain {
    ...
    public static final String[] FILTERED_STRINGS = {"file name (last part of the path)", "full path (including file name)", "parent path"};
    ...
    abstract protected void iterate(Object currentParent, Pattern filter, boolean iterateSubDirs, boolean iterateFiles, boolean recursive) throws OperatorException;
    
    protected void doWorkForSingleIterationStep(String fileName, String fullPath, String parentPath, FileObject fileObject) throws OperatorException {
    	clearAllInnerSinks();
    ...
    public List<ParameterType> getParameterTypes() {
        ...
        ParameterType type = new ParameterTypeCategory(PARAMETER_FILTERED_STRING, "Indicates which part of the file name is matched against the filter expression.", FILTERED_STRINGS, FILTERED_STRING_FILE_NAME, true);
        types.add(type);
