	...
	protected void iterate(Object currentParent, Pattern filter, boolean iterateSubDirs, boolean iterateFiles, boolean recursive) throws OperatorException {
		...
		while (entries.hasMoreElements()) {
			...
			if ( (iterateFiles && !currentEntry.isDirectory()) || (iterateSubDirs && currentEntry.isDirectory()) ) {
				if ( (recursive && parentPath.startsWith(rootDirectory)) || (   !recursive && (  (rootDirectory.isEmpty() && parentPath.isEmpty()) || (!rootDirectory.isEmpty() && parentPath.equals(rootDirectory))  )   ) ) {
