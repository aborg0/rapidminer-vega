...
public class ESParameterOptimization extends ESOptimization {
    ...
    public ESParameterOptimization(EvolutionaryParameterOptimizationOperator operator,
        ...
        super(0, 1, popSize, individualSize, initType, maxIterations, generationsWithoutImprovement, selectionType, tournamentFraction, keepBest, mutationType, crossoverProb, showPlot, false, random, logging);
