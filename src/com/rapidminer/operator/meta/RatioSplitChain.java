...
public class RatioSplitChain extends AbstractSplitChain {
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterType type = new ParameterTypeDouble(PARAMETER_SPLIT_RATIO, "Relative size of the first set. The remaining examples will be part of the second set.", 0.0d, 1.0d, 0.7d);
