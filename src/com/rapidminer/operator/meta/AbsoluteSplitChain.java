			...
			if (getParameterAsBoolean(PARAMETER_RESTRICT_FIRST)) {
				getExampleSetInputPort().addError(
						new SimpleMetaDataError(Severity.ERROR, getExampleSetInputPort(), 
								Collections.singletonList(new ParameterSettingQuickFix(this, PARAMETER_NUMBER_TRAINING_EXAMPLES, numberOfExamples.getNumber().toString())),
								"exampleset.need_more_examples", desiredSize + ""));
			} else {
				getExampleSetInputPort().addError(
						new SimpleMetaDataError(Severity.ERROR, getExampleSetInputPort(), 
								Collections.singletonList(new ParameterSettingQuickFix(this, PARAMETER_NUMBER_TEST_EXAMPLES, numberOfExamples.getNumber().toString())),
								"exampleset.need_more_examples", desiredSize + ""));
			}
		}
		if (getParameterAsBoolean(PARAMETER_RESTRICT_FIRST))
