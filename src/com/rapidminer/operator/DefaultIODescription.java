...
public class DefaultIODescription implements IODescription {
	 ...
	 * <tt>input</tt> and <tt>output</tt> may be null and may contain a class
	 * more than once.
	 */
	...
	/* (non-Javadoc)
	 * @see com.rapidminer.operator.IODescription#getOutputClasses(java.lang.Class, com.rapidminer.operator.Operator)
	 */
