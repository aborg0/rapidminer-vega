...
public interface Entry {
	...
	/** Subclasses can use this method to signal whether getting information
	 *  from this entry will block the current thread, e.g. because information must
	 *  be fetched over the network. */	
	public boolean willBlock();

	/** A location, that can be used, e.g. as a parameter in the {@link RepositorySource} or which can be used
	 *  to locate the entry using {@link RepositoryManager#resolve(String)}. */
