...
/**
 * Can be used to declare repository action conditions based upon the given list of repository {@link Entry}.
 * 
 * @author Marco Boeck
 *
 */
public interface RepositoryActionCondition {
	 ...
	 * <p>An empty list will always return true!</br>
	 * A {@code null} list will always return false!
