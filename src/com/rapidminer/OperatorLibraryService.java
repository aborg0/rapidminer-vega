...
/**
 * This singleton Service keeps track of all currently loaded {@link OperatorLibrary}s.
 * It provides methods for loading and unloading {@link OperatorLibrary}s.
 * 
 * Currently this is a singleton implementation with a static method for accessing the singleton
 * but in future this might be replaced by a per process definition.
 * 
 * Additionally it holds information for editing the Libraries. Actions can be added to
 * the toolbar as well as to the context menu. They are only available on
 * entries of the according class.
 * 
...
public class OperatorLibraryService {
    ...
    /**
     * Classes implementing this interface and having added
     * with {@link OperatorLibraryService#registerOperatorLibraryListener(OperatorLibraryListener)} will be informed whenever an
     * {@link OperatorLibrary} is added or removed.
     * 
     * @author Sebastian Land
     */
     ...
     * is informed of any registered or unregistered OperatorLibrary.
     */
