...
public interface Attributes extends Iterable<Attribute>, Cloneable, Serializable {
	...
	public static final String[] KNOWN_ATTRIBUTE_TYPES = new String[] { ATTRIBUTE_NAME, LABEL_NAME, ID_NAME, WEIGHT_NAME, BATCH_NAME, CLUSTER_NAME, PREDICTION_NAME, OUTLIER_NAME, CLASSIFICATION_COST, BASE_VALUE };
	...
	/** Sets the special attribute for the given name. If the given attribute is null, no special attribute 
	 *  with this name will be used. */
	public void setSpecialAttribute(Attribute attribute, String specialName);
	
	/** This method creates an attribute array from all regular attributes. ATTENTION:
	 *  This method should only be used if it is ensured that the attribute roles and
	 *  number of attributes cannot be changed, otherwise the delivered array will not
	 *  be synchronized with the attribute roles object. Therefore, the iterator methods
	 *  of this class should be preferred. */
	...
	/** Notifies the Attributes that this attribute will rename itself to the given
	 *  name immediately after this method returns. */
