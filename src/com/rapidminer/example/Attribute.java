...
public interface Attribute extends Cloneable, Serializable {
	 ...
	 *  This instance will be notified when the attribute renames itself. 
	 *  This method must not be called except by the {@link Attributes} to which this
	 ...
	 *  Please note that invoking this method might result in an {@link UnsupportedOperationException} for
