...
public class AttributeWeights extends AverageVector {
     ...
     * descending), and with respect to the fact if original or absolute weights should be used. Ascending means that
     * the attributes with the smallest weights come first.
     * 
     * @param direction
