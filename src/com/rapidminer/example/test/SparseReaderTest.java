...
public class SparseReaderTest extends RapidMinerTestCase {
	...
	public void readerTest(int format, Reader input, Reader labelInput) throws Exception {
		...
		SparseFormatDataRowReader reader = new SparseFormatDataRowReader(new DataRowFactory(DataRowFactory.TYPE_SPARSE_MAP, '.'), format, prefixMap, attributeSet, input, labelInput, -1);
