...
/**
 * This implementation of a sparse DataRow makes use of the
 * binary search index to maintain a sorted list of indices to 
 * save the effort of re sorting on adding a new index.
 * 
...
public class FastSparseDoubleArrayDataRow extends DataRow {
	...
	protected void ensureNumberOfColumns(int numberOfColumns) {
		// Do nothing since a runtime exception is never thrown: Default value is returned for unknown indices anyway.
	}
