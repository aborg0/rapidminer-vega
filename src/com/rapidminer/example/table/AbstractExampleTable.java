...
public abstract class AbstractExampleTable implements ExampleTable {
	 ...
	 * list belongs to the <i>i</i>-th data column. Whenever attributes are
	 ...
	 * 
	 * @param attributes
	 *            List of {@link Attribute}. The indices of the attibutes are
	 ...
	 * are null attributes in the list, the return value of this method must not
	 ...
	 * All attributes given at creation time will be regular.
	 */
	 ...
	 * in the given map will be used as special attributes with the specified names, 
	...
	public String toString() {
		return "ExampleTable, " + attributes.size() + " attributes, " + size() + " data rows,"+Tools.getLineSeparator()+"attributes: " + attributes;
	}
