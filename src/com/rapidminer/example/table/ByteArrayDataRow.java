...
/**
 * Implementation of DataRow that is backed by a byte array. Please note that using this data row
 * is quite efficient but only supports 256 different values (integers between -127 and 128 or 
 * 256 different nominal values for each column).
 * 
 * @author Ingo Mierswa
 */
public class ByteArrayDataRow extends DataRow {
	...
	/** Returns the value for the desired index. This method should only be used
	 *  by attributes. */
    @Override
	...
	/** Sets the value for the given index. This method should only be used
	 *  by attributes. */
    @Override
