 ...
 * Instances of this class always return {@link OperatorDocumentation}s from their {@link #getObject(String)} methods.
 * 
...
public class OperatorDocBundle extends ResourceBundle {
    ...
    public OperatorDocBundle(Map<String, OperatorDocumentation> operatorKeyDescriptionMap, Map<String, GroupDocumentation> groupMap) {
