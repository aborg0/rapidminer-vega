 ...
 * "OperatorsResourceConsumption.csv" file. If no value is found for a given Operator, <code>null</code> will be returned.
 * 
 * @author Marco Boeck
 */
public class OperatorResourceConsumptionHandler {
     ...
     * [3] is degreeLogarithmusExamples, [4] is degreeLogarithmusAttributes <br>
