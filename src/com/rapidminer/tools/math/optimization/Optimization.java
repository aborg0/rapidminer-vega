 ...
 * {@link #optimize()} should be invoked to start the optimization process. The
 * optimal result can be queried by the method {@link #getBestValuesEver()}.
...
public interface Optimization {
	...
	/**
	 * Should be invoked to start optimization. Since the optimization can use
	 * other (inner) operators to support fitness evaluation this method is
	 * allowed to throw OperatorExceptions.
	 */
