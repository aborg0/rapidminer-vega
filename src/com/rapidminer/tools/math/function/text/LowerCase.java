 ...
 * @author Ingo Mierswa
 */
public class LowerCase extends PostfixMathCommand {
	...
	public void run(Stack stack) throws ParseException {
		if (stack.size() != 1)
			throw new ParseException("Needs one argument: The text which should be transformed to lower case.");
