...
public class DateAdd extends PostfixMathCommand {
	...
	public void run(Stack stack) throws ParseException {
		...
		if (curNumberOfParameters == 5) {
			...
			throw new ParseException("Invalid number of arguments for 'date_add', must be 3 or 5.");
		}
		...
		if (!(dateObject instanceof Double)) {
			throw new ParseException("Invalid argument type for 'date_add', first argument must be date (double)");
		}
