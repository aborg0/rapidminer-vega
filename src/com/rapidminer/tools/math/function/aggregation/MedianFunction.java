...
public class MedianFunction extends AbstractAggregationFunction {
    ...
    public double getValue() {
        ...
        // TODO: check weighted median calculation: Middle treatment seems suspicious. Sorted arrays might be much more memory efficient
        for (Map.Entry<Double, Double> entry : valueWeightMap.entrySet()) {
            ...
            // Now check for the case that we are EXACTLY on the middle. Then we have to average with the next value
            if (valueWeightSum == totalWeight / 2) {
