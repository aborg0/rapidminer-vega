...
public abstract class WindowFunction {
	public static final Class[] FUNCTIONS = {
		RectangularWindowFunction.class,
		TriangularWindowFunction.class,
		GaussianWindowFunction.class,
		HannWindowFunction.class,
		HammingWindowFunction.class,
		BlackmanWindowFunction.class,
		BlackmanHarrisWindowFunction.class,
    ...
    public static WindowFunction createWindowFunction(String functionName, int justification, int width) throws InstantiationException, IllegalAccessException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException {
        ...
        return (WindowFunction) clazz.getConstructor(new Class[] { Integer.class, Integer.class }).newInstance(width, justification);
    }
