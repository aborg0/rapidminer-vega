...
public class ROCDataGenerator implements Serializable {
	...
	public ROCData createROCData(ExampleSet exampleSet, boolean useExampleWeights, ROCBias method) {
		...
		//rocData.addPoint(new ROCPoint(totalWeight - truePositiveWeight, truePositiveWeight, oldConfidence));		
		//} else {
		//rocData.addPoint(new ROCPoint(totalWeight - truePositiveWeight, truePositiveWeight, 0.0d)); 
		//}
