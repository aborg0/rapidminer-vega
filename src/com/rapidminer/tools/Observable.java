 ...
 *  <li>and foremost: The update method can be called on the Event Dispatch Thread (EDT) if this is desired.
 *      If you don't know, what the EDT is, read the Java docs on Swing and synchronization and use EDT if you register
 *      an observer that updates Swing GUI components.</li>
...
public interface Observable<A> {
	...
	/** Same as {@link #addObserver(Observer, boolean), but adds
	 * this observer as the first in the list.
	 */
