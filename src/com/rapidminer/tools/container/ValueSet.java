...
/**
 * This class represents a set of (weighted) double values. Might
 * be e.g. used to obtain all distinct values or to efficiently
 * store a large number of values out of a relatively small
 * domain.
 * 
...
public class ValueSet implements Iterable<Double> {
	...
	/**
	 * Returns an iterator over entries each consisting of a value
	 * and its weight.
	 */ 
