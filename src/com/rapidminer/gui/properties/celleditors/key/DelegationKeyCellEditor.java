...
/**
 * This is the key renderer for the ParameterTypeList to enable special parameter types as attributes. Or regular expressions.
 * Therefore it uses a delegation concept and tries to create the appropriate editor for the given type. 
