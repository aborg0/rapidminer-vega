 ...
 * These conditions can be mandatory, disallowed, or irrelevant. All
...
public abstract class ConditionalAction extends AbstractAction {
	 ...
	 * states the condition is MANDATORY and state is true or DISALLOWED and
	 * state is false. If for all states the condition is DONT_CARE, the
