...
public interface ConfigurationWizardCreator extends Serializable {
	...
	/**
	 * This has to return a key, which is then combined with "gui.action.wizard." for searching
	 * in the gui properties for the internationalized button text and icon. 
	 */
