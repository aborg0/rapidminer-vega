...
public abstract class AbstractGraphRenderer extends AbstractRenderer {
	...
	public List<ParameterType> getParameterTypes(InputPort inputPort) {
		...
		ParameterTypeStringCategory layoutType = new ParameterTypeStringCategory(PARAMETER_LAYOUT, "Indicates which layout should be used for graph rendering.", LAYOUTS, getDefaultLayout());
