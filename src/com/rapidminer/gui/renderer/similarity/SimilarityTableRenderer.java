...
public class SimilarityTableRenderer extends AbstractTableModelTableRenderer {
	...
	public TableModel getTableModel(Object renderable, IOContainer ioContainer, boolean isReporting) {
		SimilarityMeasureObject similarity = (SimilarityMeasureObject) renderable;
		return new SimilarityTableModel(similarity.getDistanceMeasure(), similarity.getExampleSet());
	}
}
