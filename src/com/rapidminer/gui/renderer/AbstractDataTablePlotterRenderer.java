...
/**
 * This is the abstract renderer superclass for all renderers which should be a plotter based on a given
 * {@link DataTable}.
 * 
 * @author Ingo Mierswa
 */
	...
	public List<ParameterType> getParameterTypes(InputPort inputPort) {
		...
		for (String plotterName : getPlotterSelection().keySet()) {
			...
			try {
				...
				Plotter plotter = constructor.newInstance(new Object[] { new PlotterConfigurationModel(PlotterConfigurationModel.COMPLETE_PLOTTER_SELECTION, new SimpleDataTable("ForConstruction", new String[0])) });
