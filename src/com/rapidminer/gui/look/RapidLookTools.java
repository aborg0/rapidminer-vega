...
public final class RapidLookTools {
	...
	public static void drawMenuItemBackground(Graphics g, JMenuItem menuItem) {
		...
		if (model.isArmed() || (model.isSelected() && (menuItem instanceof JMenu))) {
			...
			g2.setPaint(new GradientPaint((w > 50 ? w - 50 : 0), 0, new ColorUIResource(Color.white), w, 0, new ColorUIResource(235, 242, 255)));
	...
	public static void drawToolbarButton(Graphics g, JComponent c) {
		...
		if (c.getParent() instanceof JToolBar ||
			c.getParent() instanceof VLToolBar) {
		...
		if (b.getModel().isSelected() || (b.getModel().isPressed() && b.getModel().isArmed())) {
			...
			if (b instanceof DropDownButton ||
				b instanceof ToggleDropDownButton) {
