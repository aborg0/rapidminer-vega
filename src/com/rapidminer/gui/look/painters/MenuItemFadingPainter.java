...
public class MenuItemFadingPainter extends AbstractCachedPainter {
	...
	protected void paintToImage(Component c, Graphics g, int w, int h, Object[] args) {
		...
		g2.setPaint(new GradientPaint(0, 0, new ColorUIResource(RapidLookTools.getColors().getMenuItemBackground()), 50, 0, RapidLookTools.getColors().getMenuItemFadingColor()));
