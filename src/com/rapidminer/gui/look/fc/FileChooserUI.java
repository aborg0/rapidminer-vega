...
public class FileChooserUI extends BasicFileChooserUI {
	...
	public static final String FILECHOOSER_VIEW_THUMBNAIL = I18N.getMessage(I18N.getGUIBundle(), "gui.menu.file_chooser.view.thumbnails.label");

	public static final String FILECHOOSER_VIEW_ICON = I18N.getMessage(I18N.getGUIBundle(), "gui.menu.file_chooser.view.icons.label");

	public static final String FILECHOOSER_VIEW_LIST = I18N.getMessage(I18N.getGUIBundle(), "gui.menu.file_chooser.view.list.label");

	public static final String FILECHOOSER_VIEW_DETAILS = I18N.getMessage(I18N.getGUIBundle(), "gui.menu.file_chooser.view.details.label");
	...
	public void installComponents(JFileChooser fc) {
		...
		upFolderButton.getAccessibleContext().setAccessibleName((String) CHANGE_TO_PARENT_DIRECTORY.getValue(Action.ACCELERATOR_KEY));
		...
		this.bookmarksButton.getAccessibleContext().setAccessibleName((String) ADD_TO_BOOKMARKS_ACTION.getValue(Action.ACCELERATOR_KEY));
		...
		this.changeViewButton.getAccessibleContext().setAccessibleName((String) CHANGE_VIEW_ACTION.getValue(Action.ACCELERATOR_KEY));
