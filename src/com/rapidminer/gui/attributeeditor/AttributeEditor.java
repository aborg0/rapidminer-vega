...
public class AttributeEditor extends ExtendedJTable implements MouseListener, DataControlListener {
	...
	private final ArrayList<AttributeDataSource> sourceList = new ArrayList<AttributeDataSource>();
	...
	private final Vector<Vector<String>> dataColumnVector = new Vector<Vector<String>>();
