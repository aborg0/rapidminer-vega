...
/**
 * This condition accepts data tables with a number of columns in the specified range
...
public class ColumnsPlotterCondition implements PlotterCondition {
    ...
    public String getRejectionReason(DataTable dataTable) {
        return "Data table must have between " + minColumns + " and " + maxColumns + " columns, was " + dataTable.getNumberOfColumns() + ".";
    }
}
