...
public class Quartile {
    ...
    public Quartile(double median, double mean, double standardDeviation, 
            ...
            double lowerWhisker, double upperWhisker,
            double[] outliers) {
        this.median = median;
        this.mean = mean;
    ...
    public double getLowerWhisker() { return lowerWhisker; }
    public double getUpperWhisker() { return upperWhisker; }
	...
	public String toString() {
        return 
        "Quartile (median: " + median + ", lower q: " + lowerQuartile + ", upper q: " + upperQuartile + 
        "lower w: " + lowerWhisker + ", upper w: " + upperWhisker + ", mean: " + mean + ", sd: " + standardDeviation + 
