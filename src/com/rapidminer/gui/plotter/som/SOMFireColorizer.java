...
public class SOMFireColorizer implements SOMMatrixColorizer {
	...
	private Color[] colors = new Color[] { new Color(0, 0, 255), new Color(40, 40, 255), new Color(40, 40, 255), new Color(168, 100, 255),
			new Color(168, 100, 255), new Color(255, 100, 168), new Color(255, 100, 168), new Color(255, 40, 40), new Color(255, 40, 40),
			new Color(255, 0, 0) };
