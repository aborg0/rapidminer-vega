...
/**
 * This is an view on a given process. In contrast to the {@link OperatorTree}, this
 * is just a view that does neither allow editing of the process nor interacts with the
 * current RapidMiner state. So this can be used on processes different than the currently
 * opened one.
 * 
