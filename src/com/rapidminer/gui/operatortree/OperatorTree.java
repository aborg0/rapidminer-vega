 ...
 * 
 * Since version 5.0 this view was mainly replaced by the process flow view. See {@link ProcessRenderer}.
 * 
...
public class OperatorTree extends JTree implements TreeSelectionListener, TreeExpansionListener, MouseListener, ProcessEditor {
    ...
    public OperatorTree(MainFrame mainFrame) {
        ...
        //		getActionMap().put("toggleActivation", mainFrame.getActions().TOGGLE_ACTIVATION_ITEM.getAction());
        ...
        //		getInputMap(WHEN_FOCUSED).put(KeyStroke.getKeyStroke(KeyEvent.VK_X, InputEvent.CTRL_MASK), "cutAction");
        //		getInputMap(WHEN_FOCUSED).put(KeyStroke.getKeyStroke(KeyEvent.VK_C, InputEvent.CTRL_MASK), "copyAction");
        //		getInputMap(WHEN_FOCUSED).put(KeyStroke.getKeyStroke(KeyEvent.VK_V, InputEvent.CTRL_MASK), "pasteAction");
        //getInputMap(WHEN_FOCUSED).put(KeyStroke.getKeyStroke(KeyEvent.VK_E, InputEvent.CTRL_MASK), "toggleActivation");
        ...
        new ToolTipWindow(new TipProvider() {
            ...
            @Override
            public Component getCustomComponent(Object id) { return null; }
        }, this);
    }
