...
/**
 * This layout algorithm takes the shapes of the trees into account and performs 
 * a non-overlapping layout.
 * 
 * @author Ingo Mierswa
 */
public class ShapeBasedTreeLayout<V, E> implements Layout<V, E> {
	...
	protected Map<V, Point2D> locations = LazyMap.decorate(
			new HashMap<V, Point2D>(), new Transformer<V, Point2D>() {
