 ...
 * to the content of the text field and offers a listener concept to be informed of the changes.
 * 
...
public class ExtendedJTextField extends JTextField {
    ...
    /**
     * This is the model of an {@link ExtendedJTextField}. It offers to set and
     * get the value and has a listener concept to be informed of changes to the
     * text content.
     *
     * @author Sebastian Land
     */
