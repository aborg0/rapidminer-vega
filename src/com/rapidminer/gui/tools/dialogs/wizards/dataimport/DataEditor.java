...
public class DataEditor extends ExtendedJTable {
	...
	private static final int[][] VALUE_TYPE_OPTIONS = { 
        {}, 
        { Ontology.NOMINAL }, 
        { Ontology.NUMERICAL }, 
        { Ontology.NUMERICAL, Ontology.INTEGER }, 
        { Ontology.NUMERICAL, Ontology.REAL }, 
        { Ontology.NOMINAL, Ontology.STRING }, 
        { Ontology.NOMINAL, Ontology.BINOMINAL }, 
        { Ontology.NOMINAL, Ontology.POLYNOMINAL },
        { Ontology.NOMINAL, Ontology.FILE_PATH },
        { Ontology.DATE_TIME },        
        { Ontology.DATE_TIME, Ontology.DATE },
