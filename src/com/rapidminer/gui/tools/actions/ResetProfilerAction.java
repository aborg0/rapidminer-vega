 ...
 * @author Marco Boeck
 */
public class ResetProfilerAction extends ResourceAction {
	...
	public ResetProfilerAction(ProfilingViewer profilingViewer) {
		super(true, "reset_profiling_viewer");
		this.profilingViewer = profilingViewer;
	}

	public void actionPerformed(ActionEvent e) {
		this.profilingViewer.resetCurrent();
	}
}
