...
/**
 * This Class provides an panel for multiple content, allowing the user to switch
 * between content using a radio selection button group. 
...
public class JRadioSelectionPanel extends JPanel {
	...
	/**
	 * This method allows to add a component to this container. Hence the container provides
	 * radio buttons to toggle between components, it is needed to specify a name for the components
	 * and toolTips.
