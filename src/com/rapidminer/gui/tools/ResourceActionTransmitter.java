...
/**
 * Encapsulates an action. Transmits all actionPerformed calls to that
 * action.
 * 
...
public class ResourceActionTransmitter extends ResourceAction {
	...
	public ResourceActionTransmitter(boolean smallIcon, String i18nKey, Action action, Component fixedEventSource, Object ... i18nArgs) {
