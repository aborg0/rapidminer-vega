 ...
 * updates the filter, i.e. the visible list is filtered according to the given
 * filter value. If the value is null, the view is set back to include all actual
 * kept list values. 
 *  
