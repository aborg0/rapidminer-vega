...
public class DefaultInputHandler extends InputHandler {
	...
	public void addDefaultKeyBindings() {
		...
		addKeyBinding("C+F", SEARCH_AND_REPLACE);
	}

	/**
	 * Adds a key binding to this input handler. The key binding is a list of white space separated key strokes of the form <i>[modifiers+]key</i> where modifier is C for Control, A for Alt, or S for Shift, and key is either a character (a-z) or a
	 * field name in the KeyEvent class prefixed with VK_ (e.g., BACK_SPACE)
	 * 
	 * @param keyBinding
	 *            The key binding
	 * @param action
	 ...
	 */
	@Override
	@SuppressWarnings("unchecked") public void addKeyBinding(String keyBinding, ActionListener action) {
	 ...
	 */
	@Override
	@SuppressWarnings("unchecked") public void keyPressed(KeyEvent evt) {
	 ...
	 */
	@Override
	@SuppressWarnings("unchecked") public void keyTyped(KeyEvent evt) {
		int modifiers = evt.getModifiers();
	...
	/**
	 * Converts a string to a keystroke. The string should be of the form <i>modifiers</i>+<i>shortcut</i> where <i>modifiers</i> is any combination of A for Alt, C for Control, S for Shift or M for Meta, and <i>shortcut</i> is either a single
	 * character, or a keycode name from the <code>KeyEvent</code> class, without the <code>VK_</code> prefix.
	 * 
	 * @param keyStroke
