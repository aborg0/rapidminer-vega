...
public class ColorSelectionButton extends JButton {
	 ...
	 * 
	 * The i18nkey refers to the dialog title, which is retrieved from gui.label.-key- while the button properties are
	 * refered from: gui.action.-key-.label = Which will be the caption gui.action.-key-.acc = The accelerator key used
	 * for menu entries gui.action.-key-.tip = Which will be the tool tip gui.action.-key-.mne = Which will give you
	 * access to the mnemonics key. Please make it the same case as in the label
	 */
